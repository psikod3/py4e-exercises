...
In this assignment you will write a Python program similar to urllink2.py. The program will use urllib to read the HTML
from the data files below, and parse the data, extracting  numbers and compute the sum of the numbers in the file.
...
class="comments">88</span></td></tr> <tr><td>Hubert</td><td><span class="comments">87</span></td></tr>
...
url = input('Enter - ')  # http://py4e-data.dr-chuck.net/comments_1616381.html
